"""
Simple ML Routes (No Prefix)
Provides ML endpoints at root level for dashboard compatibility
"""
...
@router.post("/retrain")
async def retrain_model(request: dict = None):
    """Retrain ML model"""
    try:
        return {
            "status": "STARTED",
            ...
            "training_samples": request.get("samples", 10000) if request else 10000,
